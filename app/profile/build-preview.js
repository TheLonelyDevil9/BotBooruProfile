...
<div class="profile-stats-sort-row" style="width: min(100% - 24px, 966px); margin: 0 auto; padding: 24px 0 480px; color: #888; font: 14px sans-serif;">
<span id="profile-stats">[cards/stats row stub]</span>
</div>
</body>
</html>
`;
